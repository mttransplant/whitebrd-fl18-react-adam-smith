    ...
    <div className="container">
        ...
        <div className="form">
            <div className="form-group row">
                <label htmlFor="linkText" className="col-form-label">
                    Link Text
                </label>
                <input className="form-control" id="linkText" type="text" placeholder="Text displayed for link"/>
            </div>
            <div className="form-group row">
                <label htmlFor="linkURL" className="col-form-label">
                    Link URL
                </label>
                <input className="form-control" id="linkURL" type="text" placeholder="https://youtu.be/2gXh83hNnWw"/>
            </div>
            <div className="form-group row">
                <label htmlFor="widgetName" className="col-form-label">
                    Widget name
                </label>
        ...
        <h2>Preview</h2>
        <a href="https://youtu.be/2gXh83hNnWw">Text displayed for link</a>
